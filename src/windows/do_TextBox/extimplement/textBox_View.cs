...
namespace do_TextBox.extimplement
{
    /// <summary>
    ...
    /// </summary>
    public class textBox_View : UserControl, doIUIModuleView, textBox_IMethod
    {
        /// <summary>
        /// 每个UIview都会引用一个具体的model实例；
        /// </summary>
        private textBox_MAbstract model;
        ...
        {
            this.model = (textBox_MAbstract)_doUIModule;
        ...
        public async void OnPropertiesChanged(Dictionary<string, string> _changedValues)
        {
            ...
            {
                (this.Content as TextBox).Text = _changedValues["text"];
            }
